(function () {
    ...
    /** @ngInject */
    function DashboardController($scope, tenants, tenantsList, $log) {
        ...
        function activate() {
           tenants.nested(tenantsList, nestSuccess);

            function nestSuccess(tenantsNested) {
                $log.debug(tenantsNested);
                vm.list = tenantsNested;
            }
        }
